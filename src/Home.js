...
import serviceBg from './assets/service-bg.png'; // Corrected path
...
const Container = () => (
  <div className="container">
    ...
    <div className="working-process">
      ...
      <div className="step">
        <img src="https://placehold.co/100x100" alt="Image of starting a project" />
      ...
      <div className="step">
        <img src="https://placehold.co/100x100" alt="Image of project analysis" />
      ...
      <div className="step">
        <img src="https://placehold.co/100x100" alt="Image of delivering success" />
